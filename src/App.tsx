      ...
      <div className={styles.content}>
        ...
        <section className={styles.intro}>
          <div className={styles.textSection}>
            ...
            <div className={styles.paragraph}>
              <p>
                You've made it this far! This is the second load of text to see
                if the background above works well. The App file is getting a
                bit full, so time to start routing.
              </p>
              <p>
                ...
                things wide screen is good, but making everything a column can
                be a pain.
              </p>
            </div>
          </div>
